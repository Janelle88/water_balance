...
future_month_1 <- read_csv(here::here("raw_data",
                                    "future_monthly",
                                    site,
...
past_month_1 <- read_csv(here::here("raw_data",
                                  "historical_monthly",
                                  site,
                                  paste("lat",lat,"lon",lon, sep = "_"),
...
future_day_1 <- read_csv(here::here("raw_data",
                                  "future_daily",
                                  site,
                                  paste("lat",lat,"lon",lon, sep = "_"),
...
past_day_1 <- read_csv(here::here("raw_data",
                                "historical_daily",
                                site,
                                paste("lat",lat,"lon",lon, sep = "_"),
