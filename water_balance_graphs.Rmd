...
```{r, echo=FALSE, out.width="50%", fig.cap="Figure 2. Figure 2. Ecoregions in the Eastern United states based on AET and Deficit (CWD). (Tercek et al., 2021)", fig.align="center", eval=figure_lon_east}
