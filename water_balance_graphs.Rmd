...
```{r, fig.align="center", fig.cap="Figure 1. Annual averages over time. The gray line represents historical data modeled from Daymet climate data, the turquoise line represents and the yellow line represents RCP 8.5"}
