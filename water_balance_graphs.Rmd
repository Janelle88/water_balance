...
knitr::include_graphics("mccabe_and_markstrom.png")
...
knitr::include_graphics(here::here(site, "figures", paste("lat_", lat, "_lon_", lon, sep = ""), paste(site, "Scatter BY SCENARIO-",x,"--",y,".png",sep="")))
```
