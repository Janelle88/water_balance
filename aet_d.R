...
for(m in climmodel){ #open climmodel
  ...
  mydat5<-cbind(mydat3,mydat4) #join the data with metadata including date, lat, long
  
  colnames(mydat5)[]<-c("date", "lat","lon","soil_water_monthly_45", "runoff_monthly_45", "rain_monthly_45", "agdd_monthly_45", "accumswe_monthly_45", "pet_monthly_45", "deficit_monthly_45", "aet_monthly_45", "soil_water_monthly_85", "runoff_monthly_85", "rain_monthly_85", "agdd_monthly_85", "accumswe_monthly_85", "pet_monthly_85", "deficit_monthly_85", "aet_monthly_85") 
  ...
  write_csv(mydat6, here::here("sites", 
                               site, 
                               "raw_data", 
                               paste("lat",lat,"lon",lon, sep = "_"), 
